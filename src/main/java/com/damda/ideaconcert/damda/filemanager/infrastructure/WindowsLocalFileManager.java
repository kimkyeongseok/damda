...
public class WindowsLocalFileManager implements FileManager {    
    @Override
    ...
    public File getFolderFromFolderName(String folderName) {
        String path = "C:/damda/images/" + folderName + "/";
    ...
    public String base64ToImage(String dataUrl) {
        ...
        String path = "C:/damda/upload/"+ currentDate;
        /*
        * base64ToPng
        */ 
        File folder = new File(path);
    ...
    public void deleteFile(String deleteFilePath) {
        File deleteFile = new File("C:/damda" + deleteFilePath);
        deleteFile.delete();
        ...
        * base64ToSvg
        */ 
        // int startIndex = dataUrl.indexOf(",");
        // byte[] svgByte = dataUrl.substring(startIndex+1).getBytes();

        //     try {
        //         OutputStream svgOutput = new FileOutputStream(fileName+".svg");
        //         svgOutput.write(svgByte);
        //         svgOutput.close();
                
        //         TranscoderInput input_svg_image = new TranscoderInput("file:"+fileName+".svg");

        //         OutputStream png_ostream = new FileOutputStream(fileName+".png");
        //         TranscoderOutput output_png_image = new TranscoderOutput(png_ostream);
                
        //         OutputStream jpg_ostream = new FileOutputStream(fileName+".jpg");
